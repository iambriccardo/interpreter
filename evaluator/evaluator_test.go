...
func TestErrorHandling(t *testing.T) {
	tests := []struct {
		...
		{"5 + true;", "TypeMismatchError: INTEGER + BOOLEAN"},
		{"5 + true; 5;", "TypeMismatchError: INTEGER + BOOLEAN"},
		{"-true", "UnknownOperatorError: -BOOLEAN"},
		{"true + false;", "UnknownOperatorError: BOOLEAN + BOOLEAN"},
		{"5; true + false; 5", "UnknownOperatorError: BOOLEAN + BOOLEAN"},
